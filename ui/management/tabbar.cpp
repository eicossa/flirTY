...
void tgfsTabBar::mousePressEvent(QMouseEvent *event)
{
    ...
    if (event->button() == Qt::LeftButton && tabAt(event->pos()) > -1) {
        m_ghost = new tabberGhostWindow(this, event->pos());
        m_ghost->show();
    }
...
void tgfsTabBar::moveToWindow(tabbedWindow *wnd,
                              const QPoint &pos,
                              tabberGhostWindow *ghost)
{
...
void tgfsTabBar::createNewWindow(tabberGhostWindow *ghost)
{
